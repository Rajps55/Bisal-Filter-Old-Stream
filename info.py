...
PICS = (environ.get('PICS', 'https://i.postimg.cc/prXPRvsh/IXPs2c-Wx-Tt2-Ep-A5-Dcr6-QQ.webp')).split() #use a gif video 🫠
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002155777503')
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002155777503')
...
SHORTLINK_API = environ.get('SHORTLINK_API', 'fa2a0768fc8d2a51b22e46293634a52670a73c7a') #use my api so i can make some money 🤣..just kidding guys..mai already aamir hoon🥱 
SECOND_SHORTLINK_URL = environ.get('SECOND_SHORTLINK_URL', 'shortxlinks.com')
SECOND_SHORTLINK_API = environ.get('SECOND_SHORTLINK_API', 'fa2a0768fc8d2a51b22e46293634a52670a73c7a')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', True))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002237538640').split()] #Add a channel ID here. When you send any file to this channel, the bot will delete the file details from the MongoDB 
MAX_B_TN = environ.get("MAX_B_TN", "20")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/n_flixmovie')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Ie4mNf6lL5RjYjM1')
...
VERIFY_REQ_CHNL = int(environ.get('VERIFY_REQ_CHNL', '-1002183671823'))
NEW_USER_LOG = int(environ.get('NEW_USER_LOG', '-1002183671823'))
BIN_CHNL = int(environ.get('BIN_CHNL', '-1002237538640'))
